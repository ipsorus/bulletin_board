...
def db_create(car_title='', price='', phone='', car_description='', avito_item='', car_brand='', car_model='', car_generation='', 
...
steering_side='', color='', equipment='', view_place='', engine_volume='', images ='' ):
    ...
    sale_announcement = Car(car_title=car_title, price=price, phone=phone, car_description=car_description, avito_item=avito_item, 
    ...
    for image in images:
        url = image
        photo = Photo(image_url = url, car = sale_announcement)
        photo.save()
